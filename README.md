...
See [docs/paper-trading.md](docs/paper-trading.md) for the daily ETF/BTC paper-trading loops and local Docker Compose shape.
See [docs/btc-phase8-methodology.md](docs/btc-phase8-methodology.md) for the retained BTC Phase 8 methodology summary and Phase 9 handoff boundary.
